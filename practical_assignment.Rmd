...
We see that adding splines on `ODBA` leads to a better fit. It is not immediately clear which plot belongs to the observed data. Even though the middle plot belongs to the observed data, one could suspect that it would be the middle left plot.
