...
We fit a generalized linear model with Depth as a response variable. We choose the exponential family to be the Poisson family, since we expect the mean to be linear on the log scale and that the variance will increase in a fashion determined by the mean.
