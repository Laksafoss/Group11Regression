...
Furtheremore a closer inspection of the `phase` variable revials that the description of the phase levels does not correspond to the seismic activity. This is allso illustrated in Figur 1 below. As we can not contact the data collectors we have simply assumed that this is a naming error. Hence we have created a new phase variable `Newphase`. **HOW IS NEWPHASE ENCODED** 
